...
#  SUNDIALS_VERSION_MINOR - Minor version
...
foreach( LIB ${SUNDIALS_WANT_COMPONENTS} )
    ...
    find_library( SUNDIALS_${LIB}_LIBRARY_RELEASE
    ...
    if (SUNDIALS_${LIB}_LIBRARY_RELEASE)
        list( APPEND SUNDIALS_LIBS_RELEASE ${SUNDIALS_${LIB}_LIBRARY_RELEASE} )
    endif()
    mark_as_advanced(SUNDIALS_${LIB}_LIBRARY_RELEASE)
		
		# find debug libs, if any
		find_library( SUNDIALS_${LIB}_LIBRARY_DEBUG
        NAMES ${THIS_LIBRARY_SEARCH}
        PATHS
            ${SUNDIALS_USER_PATHS}
            ${SUNDIALS_ROOT}
		...
		if (SUNDIALS_${LIB}_LIBRARY_DEBUG)
        list( APPEND SUNDIALS_LIBS_DEBUG ${SUNDIALS_${LIB}_LIBRARY_DEBUG} )
    endif()
    mark_as_advanced(SUNDIALS_${LIB}_LIBRARY_DEBUG)
		
endforeach()

find_package_handle_standard_args( SUNDIALS
    REQUIRED_VARS SUNDIALS_LIBS_RELEASE SUNDIALS_INCLUDE_DIRS
