...
if(OCTAVE_ROOT)
  # don't know which subdirectory to search under OCTAVE_ROOT
  ...
  if(OCTAVE_MEX_FILE)
    ...
    set(CMAKE_PREFIX_PATH ${OCTAVE_DEV_ROOT}) # need this to find octave-config	endif()
  else()
		  message(WARNING "Octave include directory not found in path:" ${OCTAVE_ROOT})
  endif()
endif()
...
if(Development IN_LIST Octave_FIND_COMPONENTS)
  find_program(Octave_CONFIG_EXECUTABLE
               NAMES octave-config)
  #message("Octave_CONFIG_EXECUTABLE=" ${Octave_CONFIG_EXECUTABLE})
  if(Octave_CONFIG_EXECUTABLE)
    ...
    list(APPEND Octave_REQUIRED_VARS ${Octave_OCTAVE_LIBRARY} ${Octave_INTERP_LIBRARY})
		...
		#message("Octave_REQUIRED_VARS=" ${Octave_REQUIRED_VARS})
